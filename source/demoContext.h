...
class DemoContext
{
  ...
  virtual void beginPoints(float size) = 0;
  virtual void drawPoint(const Vec3& p, const Vec4& color) = 0;
  virtual void endPoints() = 0;
  ...
  //Hydrographics
  virtual void bindHydrographicShader(Vec3 lightPos, Vec3 lightTarget, Matrix44 lightTransform, ::ShadowMap* shadowMap, float bias, Vec4 fogColor) = 0;
	virtual ~DemoContext() {}
};
