...
public:
  ...
  virtual void beginPoints(float size);
  virtual void drawPoint(const Vec3& p, const Vec4& color);
  ...
  // For hydrographics
  virtual void bindHydrographicShader(Vec3 lightPos, Vec3 lightTarget, Matrix44 lightTransform, ShadowMap* shadowMap, float bias, Vec4 fogColor);
};
